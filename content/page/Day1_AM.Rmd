...
opts_chunk$set(error=TRUE, color=NULL, message=FALSE)
...
<hr class="hr2" style="margin-top:18px">
...
![](../images/nien_nunb_wide.jpg){style="width: 42%; border: 0px; float: left; margin-left: 5%; margin-right: 12px;"}
...
# What's R? 
<hr>
```{r candy, child='X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/R/R_Camp/modules/ggplot_examples/candy.Rmd'}
```
