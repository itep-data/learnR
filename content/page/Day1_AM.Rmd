...
<details>
<summary class = "btn_code_blue"> __Explore Functions Here!__ </summary>
<p>
...
The `sum()` function takes the _starwars_ages_ vector as input, performs sum calculations, and returns a single numeric object. Note that we assigned the output object to the name `ages_sum`. If we do not assign the output object it is printed to the console and not saved. Sometimes that's what we want, especially when we're exploring the data. 
