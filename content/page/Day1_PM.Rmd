...
A group of porgs (a poggle) will help to demo the `dplyr` functions. 
...
__According to the request we received, the Resistance is only interested in observations from after the year `9916`. So let's filter the data down to only dates after that year.__ 
