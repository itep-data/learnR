...
## `mutate()` PLUS `ifelse()` is powerful! {-}
...
<br>
Did it work? Yes. When **left_join** added the height column to the *starwars_homeworlds* table it only entered a value for the homeworld when the tables had a matching Star Wars character name. So when R couldn't find "Greedo" in the homeworld table, the Star Wars character's homeworld was recorded as _NA_.  
