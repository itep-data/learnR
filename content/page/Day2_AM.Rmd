...
Remember our porg friends? How rude of us not to share their names. Here's a table or their names.

![](../images/porg_names.png){style="width: 85%; max-width: 85%;"}


__Hey now!__ That's not very helpful. Who's who? Let's join them!


![](../images/left_join_porgs.png){style="width: 85%; max-width: 85%;"}
...
### <i class="fas fa-starwars" style="color: green"></i> Exercise {- .tabset}
