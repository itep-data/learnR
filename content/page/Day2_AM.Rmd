...
__What if I want to string several of these data processing functions together? Do I have to keep writing `scrap` so many times? I mean I have now written `scrap` like a million times and my fingers hurt. Mother of moons! I have rebels to protect and I haven't eaten in 2 days!__
...
![](../images/left_join_cheat.png){width="384" align="right" style="margin-top: -40px; margin-left: 40px; margin-right: 5px;"}
...
<div style="float: right; margin-left: 20px; margin-right: 30%; margin-top: 24px; width: 37%; max-width: 37%; margin-bottom: 22px;">
...
BB8 tracked down a scrap `Mass conversion table` from his old droid buddies. How does BB8 keep doing that!? If we join our scrap data to the conversion table we can really start digging into what would be a light trade. And we can do that much more efficiently now that we know `left_join()`!  
