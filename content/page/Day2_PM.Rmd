...
# _Guess the Star Wars Character_ {-}
<br>
...
Open that data set now by completing the following steps.

<br>

1. First, as always, you will load the dplyr library
1. Second, you will pull the Star Wars dataset into your environment.
I called the data **starwars_guess_who**
<br><br>
```{r, echo = T, eval = T}
...
1. Scroll through the Star Wars dataset and find a character you find interesting.
   - Or run `sample_n(starwars, 1)` to chose your character randomly.
...
1. Use the answers you receive to build a `filter()` function to narrow down the potential characters. 
1. _Elusive_ answers are encouraged.
    - For example, if someone asks you _What is your character's mass?_ 
    - You can respond _My character's mass is equal to one less than their age._ 
    - Or if you're feeling generous you can give a more straight forward answer such as _My character's mass is definitely more than 100 and less that 104._
...
1. The winner is the first to guess their neighbor's Star Wars character.

<br>

__Want a rematch? Let's make it best of 3.__
