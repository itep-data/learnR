...
__Good News__  _If you do something with data over and over again this is something you could automate in R._ 
...
- Finding R Help - See the [help page](https://itep-r.netlify.com/page/help.html)
    - R cheatsheets
...
Let's set our date column to an official date format. We can Use `ymd_hms()` because our dates are written as `year-month-day hour:minutes:seconds`.
