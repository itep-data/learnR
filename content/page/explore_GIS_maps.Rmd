...
<a href="https://itep-r.netlify.com/data/census_shapefile/census_shapfile.zip">
...
```{r, results='hide', message=F, warning=F}
# Load geography
tribal_bgs <- tribal_block_groups()

# Convert to sf filetype
tribal_bgs <- st_as_sf(tribal_bgs)
```
