...
This __From Messy to Tidy data__ exercise is available online at 
...
> First we load and/or install the necessary libraries.
...
<a href="https://itep-r.netlify.com/data/emissions_data.xlsx?raw=true">
<span class = "btn_code_blue"> __DOWNLOAD__  </span></a> —  Many WIDE emissions data files
...
###But, what if I get an entire folder of WIDE data and I need to look at all of it by next Friday???? {-}
...
<a href="https://itep-r.netlify.com/data/messy_data.zip?raw=true">
<span class = "btn_code_blue"> __DOWNLOAD__  </span></a> —  A WIDE emissions data file


##`list.files`

<br>
####`list.files()` is your friend. It provides a list of all of the file names in a folder. {-}
<br>
...
#Type in the folder where you just downloaded messy data folder
#R will look for your data there

folder_path <- "X:/Agency_Files/Outcomes/Risk_Eval_Air_Mod/_Air_Risk_Evaluation/R/R_Camp/ITEP/Web/learnR/content/data/messy_data"

folder_emissions <- list.files(folder_path)

# If you can't remember what directory you are in this function will help.
