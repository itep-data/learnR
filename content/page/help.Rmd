...
- From your browser: [DataCamp Intro](https://campus.datacamp.com/courses/free-introduction-to-r/chapter-1-intro-to-basics-1?ex=1)
...
-	From directly in `R`: [swirlR](https://swirlstats.com/students.html)  
...
- Post a question on the [ITEP R hub](https://github.com/itep-data/R-questions/issues)  
- Ask us!
    - Melinda Ronca-Battista [✉️](mailto:Melinda.Ronca-Battista@nau.edu?Subject=I%20have%20a%20R%20question)
