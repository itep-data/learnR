...
__Packages used in this training:__ 
...
To use a new _package_ you first need to install it -- much like a free App on your phone. If you'd like to get a jump start on the workshop, you can copy the text below and paste it into the RStudio console found on the left-side of the screen when you open RStudio. 

<br>

```{r, eval=F}
new_packages <- c("readr","readxl","dplyr","stringr","ggplot2","lubridate")
...
![](../../images/install_screen.png){width="88%"}
...
![](../../images/install_msg.png){width="88%"}

</div>

<br>

__Additional recommended packages:__
