...
![](../../images/R_recipe.png){style="float: left; width: 41%; margin-top: 14px; margin-right: 30px;"}

The R language and tools are built and contributed to by people from around the world. It helps you perform data analysis in a step-by-step fashion where everything is written down, kind of like you're following a recipe for cookies. Once you find your favorite recipe you can easily use it again and even share it with your collaborators.
