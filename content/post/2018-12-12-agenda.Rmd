...
![](../../images/Rstudio_ex.png){style="float: left; max-width: 30%; margin-top: 0px; margin-left: 0; margin-right: 20%;"}

![](../../images/maz_kanata.png){style="max-width: 45%; margin-left: 0; padding-top: 49px;"}
...
1. Send the corrupted data back   
    - Save data
    - Share data online
1. Summarize data
...
3. Plot `pollution` vs. `meteorology`
    - Scatter plots
        ...
        - Conc vs. Hour of day
        - Temp vs. Hour of day
4. Working with dates `lubridate` 
    - Time/Twilight Zones
5. Calendar plots
6. Intermediate data manipulation
    -	Join tables together
    -	Flip tables from __wide__ to __long__ format
        - Collapse data spread across many columns
7. Adding and calculating new columns
    - Unit conversions
    - Make new columns based on a condition _(only complete sites)_ 
...
7. Choose your own adventure!
    ...
    -	Compare years
    -	Chart & map the data 
8. **Retrieving data from the web**
    - Download NEI data from EPA
    - FTP sites
9. NEI trend charts
10. Saving plots 
11. Create custom **functions()**
    - `r knitr::inline_expr("convert_lbs_to_kgs()")`
    - ` ozone_to_AQI() `
